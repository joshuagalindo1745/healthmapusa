    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-hero pt-24">
        ...
        <section className="max-w-3xl mx-auto px-4 md:px-8 pb-6 space-y-4">
          ...
          {unsupportedMsg && (
            <div className="rounded-lg border border-border bg-card px-4 py-3 flex items-start gap-3 text-sm">
              <AlertCircle className="h-5 w-5 text-muted-foreground mt-0.5 shrink-0" />
              <p>{unsupportedMsg}</p>
            </div>
          )}
          {error && (
            <div className="rounded-lg border border-destructive/30 bg-destructive-soft text-destructive-deep px-4 py-3 text-sm">
              {error}
            </div>
          )}
        </section>
